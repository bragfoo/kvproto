...
type TikvClient interface {
	...
	RawEval(ctx context.Context, in *kvrpcpb.RawEvalRequest, opts ...grpc.CallOption) (*kvrpcpb.RawEvalResponse, error)
...
func (c *tikvClient) RawEval(ctx context.Context, in *kvrpcpb.RawEvalRequest, opts ...grpc.CallOption) (*kvrpcpb.RawEvalResponse, error) {
	out := new(kvrpcpb.RawEvalResponse)
	err := c.cc.Invoke(ctx, "/tikvpb.Tikv/RawEval", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TikvServer interface {
	...
	RawEval(context.Context, *kvrpcpb.RawEvalRequest) (*kvrpcpb.RawEvalResponse, error)
	// Store commands (to the whole tikv but not a certain region)
...
func _Tikv_RawEval_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(kvrpcpb.RawEvalRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TikvServer).RawEval(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tikvpb.Tikv/RawEval",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TikvServer).RawEval(ctx, req.(*kvrpcpb.RawEvalRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func init() { proto.RegisterFile("tikvpb.proto", fileDescriptor_tikvpb_c6920a36374c0c58) }

var fileDescriptor_tikvpb_c6920a36374c0c58 = []byte{
	// 716 bytes of a gzipped FileDescriptorProto
	,
}
